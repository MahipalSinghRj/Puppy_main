class Config{
  ...
  // static Uri tasks = Uri.parse('https://graph.microsoft.com/v1.0/me/photo/\$value');
  // static Uri task_single = Uri.parse('https://graph.microsoft.com/v1.0/me/photo/\$value');
...
String BASEURL = "http://track.smart-tech.melbourne/";
class URLHelper {
