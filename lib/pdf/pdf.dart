...
class CreatePdfState extends State<CreatePdfStatefulWidget> {
  ...
  Future<void> generateInvoice() async {
    ...
    page.graphics.drawRectangle(
        bounds: Rect.fromLTWH(0, 0, pageSize.width, pageSize.height), pen: PdfPen(PdfColor(142, 170, 219, 255)));
    //Generate PDF grid.
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    //Draw rectangle
    page.graphics.drawRectangle(
        brush: PdfSolidBrush(PdfColor(91, 126, 215, 255)), bounds: Rect.fromLTWH(0, 0, pageSize.width - 115, 90));
    //Draw string
    ...
    page.graphics.drawRectangle(
        bounds: Rect.fromLTWH(400, 0, pageSize.width - 400, 90), brush: PdfSolidBrush(PdfColor(65, 104, 205)));
  ...
  void drawFooter(PdfPage page, Size pageSize) {
    ...
    const String footerContent =
        ...
        '''800 Interchange Blvd.\r\n\r\nSuite 2501, Austin,
         TX 78721\r\n\r\nAny Questions? support@smart_tech.com''';
...
class FlutterPdfPrinter {
  static const MethodChannel _channel = MethodChannel('flutter_pdf_printer');
  ...
  static Future<void> printFile(String filePath) async {
    if (filePath == null || filePath.isEmpty) {
      throw const FormatException("filePath given is null or empty");
    }
